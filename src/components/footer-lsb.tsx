...
export default function FooterLSB() {
  return (
    <footer className="relative bg-black border-t border-gray-800 py-12 px-4 overflow-hidden">
      ...
      <motion.div
        className="absolute top-10 -right-16 -translate-x-1/2"
        animate={{
          y: [0, -8, 0],
          rotate: [0, -5, 0, 5, 0],
        }}
      ...
      <div className="relative z-10 max-w-6xl space-y-6 mx-auto text-center">
